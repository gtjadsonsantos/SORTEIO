export default class Winners_DrawsVO {
  private winner_id?: number;
  private participants_draw_participant_id?: number;
  ...
  public getParticipants_draw_participant_id(): number | undefined {
    return this.participants_draw_participant_id;
  }

  public setParticipants_draw_participant_id(
    participants_draw_participant_id: number | undefined
  ): void {
    this.participants_draw_participant_id = participants_draw_participant_id;
  }
