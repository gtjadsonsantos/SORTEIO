...
exports.default = {
    indexOne: function (userVO) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var responseDAO, responseBO, cpfValidate;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, UserDAO_1.default.indexOneByCpf(userVO)];
                    case 1:
                        responseDAO = _c.sent();
                        responseBO = "";
                        cpfValidate = userVO.getCpf();
                        if (!cpf_cnpj_validator_1.cpf.isValid(cpfValidate)) return [3 /*break*/, 5];
                    ...
                    case 5:
                        ...
                        _c.label = 6;
                    case 6: return [2 /*return*/, responseBO];
                }
            });
        });
    },
