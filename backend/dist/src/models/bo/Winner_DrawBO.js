...
var Winner_DrawDAO_1 = __importDefault(require("../dao/Winner_DrawDAO"));
exports.default = {
    indexOne: function (winner_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Winner_DrawDAO_1.default.indexOne(winner_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = [];
    ...
    indexAll: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Winner_DrawDAO_1.default.indexAll()];
                    case 1:
                        responseDAO = _a.sent();
    ...
    create: function (winner_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Winner_DrawDAO_1.default.create(winner_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    update: function (winner_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Winner_DrawDAO_1.default.update(winner_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    delete: function (winner_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Winner_DrawDAO_1.default.delete(winner_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
