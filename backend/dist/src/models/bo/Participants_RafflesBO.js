...
var Participants_RafflesDAO_1 = __importDefault(require("../dao/Participants_RafflesDAO"));
exports.default = {
    indexOne: function (participant_ruffleVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Participants_RafflesDAO_1.default.indexOne(participant_ruffleVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = [];
    ...
    indexAll: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Participants_RafflesDAO_1.default.indexAll()];
                    case 1:
                        responseDAO = _a.sent();
    ...
    create: function (participant_ruffleVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Participants_RafflesDAO_1.default.create(participant_ruffleVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    update: function (participant_ruffleVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Participants_RafflesDAO_1.default.update(participant_ruffleVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    delete: function (participant_ruffleVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Participants_RafflesDAO_1.default.delete(participant_ruffleVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
