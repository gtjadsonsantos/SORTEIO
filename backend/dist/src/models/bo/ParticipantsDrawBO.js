...
var ParticipantsDrawDAO_1 = __importDefault(require("../dao/ParticipantsDrawDAO"));
exports.default = {
    indexOne: function (participant_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ParticipantsDrawDAO_1.default.indexOne(participant_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
    ...
    indexAll: function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ParticipantsDrawDAO_1.default.indexAll()];
                    case 1:
                        responseDAO = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ParticipantsDrawDAO_1.default.create(participant_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    update: function (participant_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ParticipantsDrawDAO_1.default.update(participant_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
    ...
    delete: function (participant_DrawVO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ParticipantsDrawDAO_1.default.delete(participant_DrawVO)];
                    case 1:
                        responseDAO = _a.sent();
                        responseBO = "";
                        if (responseDAO) {
