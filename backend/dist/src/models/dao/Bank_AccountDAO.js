...
exports.default = {
    indexOne: function (bank_accountVO) {
        return __awaiter(this, void 0, void 0, function () {
            var listBank_AccountVO, listBankAccount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listBank_AccountVO = [];
                        return [4 /*yield*/, conn_1.default("banks_accounts")
                                .select("*")
                                .where("bank_account_id", "=", "" + bank_accountVO.getBank_account_id())
                                .where("deleted_at", null)];
                    case 1:
                        listBankAccount = _a.sent();
                        listBankAccount.forEach(function (item) {
                            var bank = new Bank_AccountVO_1.default();
                        ...
                        return [2 /*return*/, listBank_AccountVO];
                }
            });
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, conn_1.default("banks_accounts").insert({
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, conn_1.default("banks_accounts").update({
                                name: bank_accountVO.getName(),
                                agency: bank_accountVO.getAgency(),
                                number_account: bank_accountVO.getNumber_account(),
                                image: bank_accountVO.getImage(),
