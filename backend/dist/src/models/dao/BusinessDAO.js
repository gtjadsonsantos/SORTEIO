...
var BusinessVO_1 = __importDefault(require("../vo/BusinessVO"));
exports.default = {
    indexOne: function (businessVO) {
        return __awaiter(this, void 0, void 0, function () {
            var listBusinessVO, listBusiness;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        listBusinessVO = [];
                        return [4 /*yield*/, conn_1.default("business")
                                .select("*")
                                .where("business_id", "=", "" + businessVO.getBusiness_id())
                                .where("deleted_at", null)];
                    case 1:
                        listBusiness = _a.sent();
                        listBusiness.forEach(function (item) {
                            var business = new BusinessVO_1.default();
                        ...
                        return [2 /*return*/, listBusinessVO];
                }
            });
        });
    },
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, conn_1.default("business").insert({
