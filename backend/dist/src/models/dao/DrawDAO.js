...
var DrawVO_1 = __importDefault(require("../vo/DrawVO"));
exports.default = {
    indexOne: function (drawVO) {
        return __awaiter(this, void 0, void 0, function () {
            var listDrawVO, listDraw;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        listDraw = _a.sent();
                        listDraw.forEach(function (item) {
                            var draw = new DrawVO_1.default();
    ...
    indexAllJoinDrawsImages: function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, conn_1.default("draws").insert({
